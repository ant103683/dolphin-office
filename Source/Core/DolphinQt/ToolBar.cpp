...
void ToolBar::MakeActions()
{
  ...
  m_bindKey_action = addAction(tr("BindKey"), this, &ToolBar::BindKeyPressed);
  ...
  for (const auto& action :
       {m_open_action, m_pause_play_action, m_stop_action, m_stop_action, m_fullscreen_action,
        m_screenshot_action, m_config_action, m_graphics_action, m_controllers_action, m_bindKey_action,
...
void ToolBar::UpdateIcons()
{
  ...
  m_bindKey_action->setIcon(Resources::GetThemeIcon("classic"));
}
